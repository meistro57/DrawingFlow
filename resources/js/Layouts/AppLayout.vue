            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:space-x-4">
                        <div class="relative">
                            ...
                            >
                                ...
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M15 17h5l-1.4-1.4a2 2 0 01-.6-1.4V11a6 6 0 10-12 0v3.2a2 2 0 01-.6 1.4L4 17h5m6 0a3 3 0 11-6 0m6 0H9" />
                                </svg>
                                <span v-if="unreadCount > 0" class="absolute -right-1 -top-1 inline-flex min-h-5 min-w-5 items-center justify-center rounded-full bg-red-600 px-1 text-[10px] font-semibold text-white">
                            ...
                            >
                                ...
                                <div v-if="isLoadingNotifications" class="px-4 py-6 text-center text-sm text-gray-500 dark:text-slate-400">
                                    Loading...
                                </div>
                                <div v-else-if="notifications.length === 0" class="px-4 py-6 text-center text-sm text-gray-500 dark:text-slate-400">
                                    No notifications yet.
                                </div>
                                <div v-else class="max-h-96 divide-y divide-gray-200 overflow-y-auto dark:divide-slate-700">
                                    <button
                                    ...
                                    >
                                        <div class="flex items-start gap-2">
                                            <span
                                                ...
                                                :class="notification.read_at ? 'bg-gray-300 dark:bg-slate-600' : 'bg-primary-600'"
                                            />
                                            <div>
                        ...
                        >
                            <span class="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full bg-slate-200 text-xs font-semibold text-slate-700 dark:bg-slate-700 dark:text-slate-100">
                                <img
            ...
            <div v-show="showMobileMenu" class="sm:hidden border-t border-gray-200 dark:border-slate-800">
                ...
                <div class="pt-4 pb-3 border-t border-gray-200 px-4 dark:border-slate-800">
                    ...
                    <Link :href="route('profile.edit')" class="flex items-center gap-3 rounded-xl px-1 py-2">
                        <span class="flex h-10 w-10 items-center justify-center overflow-hidden rounded-full bg-slate-200 text-sm font-semibold text-slate-700 dark:bg-slate-700 dark:text-slate-100">
                            <img
                                v-if="user?.avatar_url"
                                :src="user.avatar_url"
                                :alt="`${user.name} avatar`"
