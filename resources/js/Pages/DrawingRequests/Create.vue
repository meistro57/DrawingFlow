...
const props = defineProps({
    ...
    projects: Array,
    users: Array,
    preselected_project_id: [Number, String],
});

const form = useForm({
    project_id: props.preselected_project_id || '',
    customer_id: '',
    assigned_to_user_id: '',
    title: '',
    description: '',
...
function submit() {
    form.post(route('drawing-requests.store'));
}
</script>

<template>
    <AppLayout>
        <Head title="New Drawing Request" />
        ...
        <div class="py-8">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mb-6">
                    ...
                    <h1 class="mt-2 text-2xl font-bold text-gray-900">New Drawing Request</h1>
                </div>
                ...
                <form @submit.prevent="submit" class="bg-white shadow-sm rounded-lg border border-gray-200">
                    <div class="p-6 space-y-6">
                        <div>
                            ...
                            <input v-model="form.title" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" placeholder="e.g. Steel beam detail for Level 3" />
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <input v-model="form.drawing_type" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" placeholder="e.g. Structural" />
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <textarea v-model="form.description" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" placeholder="Describe the drawing request details..."></textarea>
                        </div>
                    ...
                    <div class="border-t border-gray-200 px-6 py-4 bg-gray-50 flex justify-end space-x-3">
                        <Link :href="route('drawing-requests.index')" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest bg-white hover:bg-gray-50 transition">
                            Cancel
                        </Link>
