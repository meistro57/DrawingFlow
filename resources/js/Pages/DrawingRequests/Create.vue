          ...
          <div class="p-6 space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="e.g. Steel beam detail for Level 3"
              />
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
              ...
              <div>
                ...
                >
                  ...
                  <option
                    v-for="drawingType in drawingTypes"
                    :key="drawingType"
                    :value="drawingType"
                  >
                    {{ drawingType }}
                ...
                <p v-if="form.errors.drawing_type" class="mt-1 text-sm text-red-600">
                  {{ form.errors.drawing_type }}
                </p>
              </div>
              <div>
            ...
            <div>
              ...
              <textarea
                ...
                rows="4"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                placeholder="Describe the drawing request details..."
              ></textarea>
            </div>
