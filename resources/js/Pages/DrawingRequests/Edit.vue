...
const { filteredProjects, onCustomerChange, onProjectChange } = useDrawingRequestAutofill(
  props,
  form
);
  ...
  <AppLayout>
    ...
    <div class="py-8">
      <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
          <Link
            :href="route('drawing-requests.show', drawingRequest.id)"
            class="text-sm text-gray-500 hover:text-gray-700"
            >&larr; Back to {{ drawingRequest.request_number }}</Link
          >
          <h1 class="mt-2 text-2xl font-bold text-gray-900">
            Edit {{ drawingRequest.request_number }}
          </h1>
        </div>
