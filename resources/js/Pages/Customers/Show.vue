                    ...
                    <div class="lg:col-span-2 bg-white shadow-sm rounded-lg border border-gray-200">
                        ...
                        <dl class="divide-y divide-gray-200">
                            ...
                            <div v-if="customer.notes" class="px-6 py-4 grid grid-cols-3 gap-4">
                                ...
                                <dd class="text-sm text-gray-900 col-span-2 whitespace-pre-line">{{ customer.notes }}</dd>
                            </div>
                        </dl>
                    </div>
                        ...
                        <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6">
                            ...
                            <dl class="space-y-4">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <dd class="text-sm font-semibold text-gray-900">{{ customer.drawing_requests_count }}</dd>
                                </div>
                                <div class="flex justify-between">
                                    <dt class="text-sm text-gray-600">Submittals</dt>
                                    <dd class="text-sm font-semibold text-gray-900">{{ customer.submittals_count }}</dd>
                                </div>
                            </dl>
                        </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="project in customer.projects" :key="project.id" class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <Link :href="route('projects.show', project.id)" class="text-primary-600 hover:text-primary-800 font-medium">
